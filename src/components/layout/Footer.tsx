          ...
          <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr] lg:gap-8">
            <div className="space-y-6">
              <Link href="/" className="block max-w-[220px] origin-left transition-transform hover:scale-[1.02]">
                <Image src="/logo_name.png" alt="Techglaz Labs - Let's Create Your own Future" width={220} height={72} className="w-full object-contain brightness-95 dark:brightness-100" style={{ height: "auto" }} />
              </Link>
